...
THREE.Loader.prototype = {
    ...
    createMaterial: function (a, b) {
        ...
        } else l = new THREE[j](l); if (a.DbgName !== void 0) l.name = a.DbgName;
        return l
    }
};
...
THREE.SVGRenderer = function () {
    ...
    function b(a) {
        if (A[a] == null) {
            A[a] = document.createElementNS("", "path");
    ...
    var d = this,
        ...
        j = document.createElementNS("", "svg"),
                ...
                if (A instanceof THREE.RenderableParticle) {
                    ...
                    if (u.intersects(t)) {
                        ...
                        var Y = q,
                            F = P++;
                        if (J[F] == null) {
                            J[F] = document.createElementNS("", "line");
...
THREE.WebGLRenderer = function (a) {
    ...
    var a = a || {}, E = a.canvas !== void 0 ? a.canvas : document.createElement("canvas"),
