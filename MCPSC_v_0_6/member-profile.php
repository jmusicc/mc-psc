...
<link href="loginmodule.css" rel="stylesheet" type="text/css" />
	<meta charset="utf-8">
	<title><?php echo $skin_title; ?></title>
	<style>
		body {
			font-size: 13px;
		}
...
<div class="wrapper"><h1><?php echo $skin_header; ?></h1>
<?php include('menu.php'); ?>
<br><br>
<p>
<div class="mainframe"><h1><?php echo $skin_current; ?></h1><br />
<form name="imageform" action="upload_skin.php" method="post"
enctype="multipart/form-data">
<label for="file"><?php echo $skin_new; ?></label>
<input type="file" name="file" id="file"><br>
<?php echo $skin_size; ?>
<input type="submit" name="submit" value="<?php echo $skin_upload_button; ?>">
</form>
<form name="erasecloak" action="del_skin.php" method="post" enctype="multipart/form-data">
<input type="submit" name="submit" value="<?php echo $skin_delete_button; ?>">
</form>
<h1></h1>
<form name="imageform" action="upload_cape.php" method="post"
enctype="multipart/form-data">
<label for="file"><?php echo $skin_cape_new; ?></label>
<input type="file" name="file" id="file"><br>
<?php echo $skin_size; ?>
<input type="submit" name="submit" value="<?php echo $skin_upload_button; ?>">
</form>

<form name="erasecloak" action="del_cape.php" method="post" enctype="multipart/form-data">
<input type="submit" name="submit" value="<?php echo $skin_delete_button; ?>">
</form>
<h1></h1>
<div id="skinpreview" style=""></div><h1></h1>

<?php 
if (filesize($cloakpath.$cape) != '0') {
	echo "<h2><center>".$skin_cape_pic."</center></h2>";}
	else{
		echo "<h2><center>".$skin_cape_nopic."</h2></center>";
		}
    ?>
...
if ($cape != null) {
	?>
<img width="512" height="256" src="<?php echo $cloakpath.$skin; ?>" />
<?php } ?>
...
var MSP = (function (global, undefined) {
	...
	var capeMaterial = getMaterial(capecanvas, true);
	...
	spinBoxLabel.textContent = "<?php echo $skin_interface_1; ?>";
	...
	moveBoxLabel.textContent = "<?php echo $skin_interface_2; ?>";
	...
	yFreezeBoxLabel.textContent = "<?php echo $skin_interface_3; ?>";
	...
	capeBoxLabel.textContent = "<?php echo $skin_interface_4; ?>";
	...
	runBoxLabel.textContent = "<?php echo $skin_interface_5; ?>";
	...
	var defaultcapes = [
		<?php echo "'$cloakpath$skin'" ?>,
	];
	
	var cape = new Image();
    cape.src = defaultcapes[Math.floor(Math.random()*defaultcapes.length)];	
